...
data class Item(var name :String ,var subTitle:String ,var image:Int,var id:Int)
var itemList = arrayListOf(
    ...
    Item("고급 게이밍 의자", "이것만 있음 나도 페이커...?", R.drawable.chair_3,2),
    Item(
        "할아버지의 품격 있는 의자",
...
fun itemCategory(item:Int):String{
    when(item){
        in 0..4->{
            return  chair
        }
