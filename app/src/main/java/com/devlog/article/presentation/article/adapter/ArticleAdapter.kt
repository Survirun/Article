...
//            ContextCompat.startActivity(context, intent, activityOptions.toBundle())
        ...
        holder.binding.reportButton.visibility = isVisibility

        holder.binding.reportButton.setOnClickListener {
            articleReportClickListener(articleList[position].articleId)
        }
    ...
    fun setProductList(productList: List<ArticleEntity>, productItemClickListener: (link:ArticleEntity) -> Unit={ } ,articleShareClickListener:(link:ArticleEntity)->Unit ={} ,articleBookmarkClickListener:(link:ArticleEntity)->Unit ={}, articleReportClickListener:(articleId:String)->Unit={}, isVisibility : Int){
        ...
        this.articleReportClickListener = articleReportClickListener
